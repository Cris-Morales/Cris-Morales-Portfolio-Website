...
export default function Header() {
    ...
    return (
        <header className="z-50 flex justify-between fixed w-screen h-header py-3 px-4 md:px-7  bg-background bg-opacity-50 backdrop-blur-xl xl:bg-opacity-0 xl:backdrop-blur-none">
