...
export default function ContactForm() {
    ...
    return (
        ...
        <form action={dispatch} className="border-2 border-primary boxGlow rounded-3xl flex flex-col justify-center items-center p-5 xl:px-5 xl:py-5 w-5/6 xl:w-1/3">
            ...
            <input required type="text" id="name" name="name" className="rounded-md bg-background bg-opacity-35 border-2 border-primary py-1 px-2 mb-2 w-3/4" />
            <label className="mb-2 text-base">
                Email
            </label>
            ...
            <input required type="text" id='subject' name="subject" className="rounded-md bg-background bg-opacity-35 border-2 border-primary py-1 px-2 mb-4 w-3/4" />
            <label className="mb-2 text-base">
                Message
            </label>
            <textarea required id='message' name="message" className="rounded-md bg-background bg-opacity-35 border-2 border-primary py-2 px-2 mb-4 text-wrap w-3/4 max-h-fit min-h-40" />
